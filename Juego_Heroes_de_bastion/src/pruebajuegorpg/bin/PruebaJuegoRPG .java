...
public class PruebaJuegoRPG {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenidos a heroes del bation: ");
                        ...
                        if (turnoJugador) {
                            ...
                            switch(elegirAtaque){
                                case 1:
                                    ...
                                    dañoTotal=miPersonaje[choisePer].datoRealizado(dañoTotal, miEnemigo[choiseEne]);
                                ...
                                case 3:
                                	dañoTotal=miPersonaje[choisePer].tercerAtaque(miPersonaje[choisePer]);
                                	dañoTotal=miPersonaje[choisePer].datoRealizado(dañoTotal, miEnemigo[choiseEne]);
                                    System.out.println("El daño total fue de "+dañoTotal+"\nLa nueva vida de "+miEnemigo[choiseEne].getNombre()+" es: "+miEnemigo[choiseEne].getHpReal());
                                    break;
                                    
                                case 4:
                                	dañoTotal=miPersonaje[choisePer].cuartoAtaque(miEnemigo[choiseEne]);
                                	dañoTotal=miPersonaje[choisePer].datoRealizado(dañoTotal, miEnemigo[choiseEne]);
                                	System.out.println("El daño total fue de "+dañoTotal+"\nLa nueva vida de "+miEnemigo[choiseEne].getNombre()+" es: "+miEnemigo[choiseEne].getHpReal());
                                	break;
                            ...
                            switch(elegirAtaque){
                                case 1:
                                    ...
                                    dañoTotal=miEnemigo[choiseEne].datoRealizado(dañoTotal, miPersonaje[choisePer]);
                                ...
                                case 3:
                                    ...
                                    dañoTotal=miEnemigo[choiseEne].tercerAtaque(miEnemigo[choiseEne]);
                                    dañoTotal=miEnemigo[choiseEne].datoRealizado(dañoTotal, miPersonaje[choisePer]);
                                    System.out.println("El daño total fue de "+dañoTotal+"\nLa nueva vida de "+miPersonaje[choisePer].getNombre()+" es: "+miPersonaje[choisePer].getHpReal());
                                    break;
                                ...
                                case 4:
                                    ...
                                    dañoTotal=miPersonaje[choiseEne].cuartoAtaque(miPersonaje[choisePer]);
                                    dañoTotal=miEnemigo[choiseEne].datoRealizado(dañoTotal, miPersonaje[choisePer]);
                                    if(dañoTotal >= 0.0) {
                                    System.out.println("El daño total fue de "+dañoTotal+"\nLa nueva vida de "+miPersonaje[choisePer].getNombre()+" es: "+miPersonaje[choisePer].getHpReal());
                                    }else
